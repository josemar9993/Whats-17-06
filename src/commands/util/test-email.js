...
module.exports = {
    ...
    async execute(message, args, client) {
        try {
            ...
            if (!to) {
                await message.reply('Destinatário de teste não configurado. Defina EMAIL_TO no .env ou config.js.');
                return;
            }
            ...
            await message.reply('E-mail de teste enviado com sucesso! Verifique a caixa de entrada.');
        } catch (error) {
            await message.reply('Houve um erro ao tentar enviar o e-mail de teste: ' + (error.message || error));
        }
    },
};
